    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="chatbox">
            ...
            <div class="custom-tab-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="../assets/#notes">Notes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="../assets/#alerts">Alerts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="../assets/#chat">Chat</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade active show" id="chat" role="tabpanel">
                        <div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
                            <div class="card-header chat-list-header text-center">
                                <a href="../assets/javascript:void(0)"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="card chat dz-chat-history-box d-none">
                            <div class="card-header chat-list-header text-center">
                                <a href="../assets/javascript:void(0)" class="dz-chat-history-back">
                                ...
                                <div class="dropdown">
                                    <a href="../assets/javascript:void(0)" data-toggle="dropdown"><svg
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xl-9 col-xxl-12">
                        <div class="row">
                            <div class="col-xl-8 col-xxl-12">
                                <div class="row">
                                    <div class="col-xl-12" style="height:27pc">
                                        <div class="card">
                                            <div class="card-body pt-2 pb-0 border border-dark">
                                                <div id="reader"></div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div id="reader" class="mb-5" style="width:47pc;height:100%;margin:auto"></div>
                <form action="/insertabsen" method="POST">
                    @csrf
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Sudah Absen</h4>
                            </div>
                            <div class="card-body">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../assets/http://dexignzone.com/"
