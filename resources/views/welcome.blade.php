									...
									<div class="card-body pb-0 dz-scroll height630 loadmore-content" id="latestSalesContent">
										...
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												...
												<div class="mr-auto">
													<h4 class="fs-14 mb-0"><a href="page-error-404.html" class="text-black">Jacob Swing Swing</a></h4>
										...
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												...
												<div class="mr-auto">
													<h4 class="fs-14 mb-0"><a href="page-error-404.html" class="text-black">Robert Carloz</a></h4>
										...
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												...
												<div class="mr-auto">
													<h4 class="fs-14 mb-0"><a href="page-error-404.html" class="text-black">Kevin Stefanus</a></h4>
													<span class="fs-12">2m ago</span>
												</div>
												<span class="badge badge-sm light badge-primary">1 Ticket</span>
											</div>
